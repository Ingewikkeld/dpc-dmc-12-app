...
Dmpc.view.templates.SocialRightDMC = '<h2>' +
	'Hosts?</h2>' +
'<p>' +
	'The DMC Conference Social is brought to you by:<br>' +
	'<a href="http://www.engineyard.com/" target="_blank"><img src="resources/images/engineyard.jpg" class="eyimg"></a>&nbsp;&nbsp;</p>' +
'<blockquote>' +
	'<p>' +
		'<em>"Engine Yard is thrilled to be a part of DMC this year. We are proud to be sponsoring the social event specifically, because we love when talented people from all over the globe are brought together in a relaxed, fun atmosphere. We\'ve found that\'s where community bonds strengthen, where interesting conversations happen, and where ideas are born, and we\'re happy to help make that happen at DMC.</em>"<br>' +
